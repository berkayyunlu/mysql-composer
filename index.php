                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><a href="edit.php?id=<?php echo $user['user_id'] ?>"><button>Edit </button></td></a>
                                <td align="center"><a href="datamodel.php?id=<?php echo $user['user_id'] ?>&deleteinf=ok" "><button>Delete </button></td></a> 
